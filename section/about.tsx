    ...
    <section className="bg-white px-5 py-16 text-[#111111] md:px-10 sm:py-20 lg:px-12 lg:py-24">
      <div className="mx-auto max-w-[1800px] overflow-hidden rounded-[14px] border border-black/10 bg-white">
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div
            className="relative min-h-[430px] overflow-hidden border-b border-black/10 bg-[#111111] lg:aspect-[6/5] lg:min-h-0 lg:border-b-0 lg:border-r"
            data-aos="fade-up"
          >
            <img
          ...
          <div className="bg-[#fbfbfb]">
            <div className="p-6 sm:p-8 lg:p-10 xl:p-12">
              ...
              <h2 className="mt-5 max-w-[920px] text-[38px] font-normal leading-[1.07] tracking-[-0.03em] sm:text-[48px] lg:text-[54px]">
                We make brands look sharper, sound clearer and grow faster.
              </h2>

              <p className="mt-5 max-w-[760px] text-[16px] leading-7 text-black/64">
              ...
              <div className="mt-7 grid gap-4 md:grid-cols-3">
                {PILLARS.map((pillar, index) => (
                  <article
                    key={pillar.title}
                    className="group rounded-lg border border-black/10 bg-white p-4 shadow-[0_16px_42px_rgba(0,0,0,0.05)] transition-colors duration-300 hover:border-[#d71920] hover:bg-[#fff8f8]"
                    data-aos="fade-up"
                  ...
                  >
                    ...
                    <h3 className="mt-4 text-[22px] font-normal leading-none tracking-[-0.03em]">
                      {pillar.title}
                    </h3>
          ...
          <div className="grid border-t border-black/10 bg-white sm:grid-cols-3 lg:col-span-2">
